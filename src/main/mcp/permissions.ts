 ...
 *
 * - 分类表静态覆盖且仅覆盖 docs/08 §6 的 12 个 tool（本期全 READ_ONLY）；
...
/** M2 权限分类表：覆盖且仅覆盖本期 12 个 tool，值全为 READ_ONLY（docs/08 §6）。 */
 ...
 * 仅影响 assertPermission 的判定；M2 的 12 个 READ_ONLY tool 不经此入口。
 */
