 ...
 *
 * - createDevhubMcpServer(): McpServer —— 注册 12 个点分名 tools、6 个
 *   devhub://* resources、4 个 prompts；对传输零感知（§11）。
...
/** 12 个 tools（点分名），注册顺序稳定（tools/list 输出确定）。 */
...
/** 组装 DevHub MCP Server：12 tools + 6 resources + 4 prompts，权限管线就位。 */
