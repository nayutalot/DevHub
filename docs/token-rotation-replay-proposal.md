...
> **裁决终局（2026-09-14 主控裁）**：D1–D7 **甲档全收**（D1=内存 Map 不建新表 / D2=接受重启
> 缺口，重配对兜底 / D3=单设备单槽 / D4=绝不越窗 300s / D5=寿命单源 grace_expires_at /
> D6=不适用 / D7=三防线零新认证材料）；**编码不立项**。正式契约已入册 docs/18 §3.14.1 +
> ecs-relay/README.md 偏离单 #11 更正（同 commit）。本文档**留作裁决记录**（§2「待裁决」
> 孔位与 §3 决策点选项自此冻结，以本注记为准）。
>
